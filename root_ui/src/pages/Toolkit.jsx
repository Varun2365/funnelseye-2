          ...
          <VStack spacing={8} textAlign="center">
            ...
            <VStack spacing={4}>
              ...
              <Text fontSize="lg" color="gray.600">
                Your information has been submitted successfully. You'll receive your {leadMagnet.title} shortly.
              </Text>
            </VStack>

            <Card bg="white" shadow="lg" borderRadius="2xl" p={8} w="full" maxW="md">
              <VStack spacing={4} align="start">
                <HStack spacing={3}>
                  <Icon as={leadMagnet.icon} color={leadMagnet.color} boxSize={6} />
                  <Heading size="lg" color="gray.900">{leadMagnet.title}</Heading>
                </HStack>
                <Text color="gray.600">{leadMagnet.description}</Text>
    ...
    return (
      <>
        ...
        <Box
          ...
          right="0"
          bottom="0"
          bgGradient="linear(135deg, #10b981 0%, #059669 25%, #047857 50%, #065f46 100%)"
          opacity="0.05"
        />
