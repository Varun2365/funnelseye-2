...
export const welcomeTemplates = {
      welcomeTemplates: {
        'warm_welcome': {
            name: '1 Funnel landing page customar page',
...
(function() {
  ...
  window.toggleFAQ = function(index) {
    ...
    if (!answer || !arrow) {
      console.error('FAQ elements not found:', index);
      return;
    }
  ...
  function generateTransformations() {
    const testimonials = [
      { name: 'Priya S.', role: 'Marketing Head, Mumbai', quote: 'Lost 8 kgs in 60 days despite a crazy travel schedule. This system is pure magic for busy people like me.', badges: ['Lost 8 kgs', 'Energy Boost', '60 Days'] },
      { name: 'Amit K.', role: 'IT Project Manager, Bangalore', quote: 'My energy levels are through the roof. I am more productive at work and finally have energy for my kids in the evening.', badges: ['15 kgs Lost', 'Better Sleep', '90 Days'] },
      { name: 'Sunita M.', role: 'Entrepreneur, Delhi', quote: 'I thought I had to choose between my business and my health. This proved me wrong. Best investment I have ever made.', badges: ['12 kgs Lost', 'Business Growth', '75 Days'] },
      { name: 'Rajesh P.', role: 'Software Engineer, Pune', quote: 'From 3 PM energy crashes to all-day productivity. This system transformed my entire lifestyle and career.', badges: ['18 kgs Lost', 'No Energy Crashes', '45 Days'] },
      { name: 'Kavita R.', role: 'HR Manager, Chennai', quote: 'Finally found a system that works with my hectic schedule. Lost weight without compromising my family time.', badges: ['10 kgs Lost', 'Family Time', '60 Days'] },
      { name: 'Vikram S.', role: 'Sales Director, Hyderabad', quote: 'This system saved my life. Diabetes under control, energy restored, and confidence back. Thank you!', badges: ['20 kgs Lost', 'Diabetes Control', '90 Days'] },
      { name: 'Meera J.', role: 'Banking Professional, Kolkata', quote: 'Never thought I could transform at 45. This system proved age is just a number. Feeling 25 again!', badges: ['14 kgs Lost', 'Youthful Energy', '75 Days'] },
      { name: 'Arjun M.', role: 'Startup Founder, Gurgaon', quote: 'From startup stress eating to healthy habits. This system helped me build discipline that reflects in my business too.', badges: ['16 kgs Lost', 'Better Focus', '60 Days'] },
      { name: 'Rohit K.', role: 'Consultant, Mumbai', quote: 'Travel-friendly system that works in hotels, airports, anywhere. Finally, a solution for frequent travelers!', badges: ['11 kgs Lost', 'Travel Friendly', '50 Days'] },
      { name: 'Neha T.', role: 'Corporate Lawyer, Delhi', quote: 'High-pressure job, irregular hours, but this system adapted to my life. Lost weight without losing my edge.', badges: ['13 kgs Lost', 'High Performance', '65 Days'] }
    ];
    
    const track = document.querySelector('.transformations-top-track');
    if (!track) {
  ...
  function setupTestimonialControls() {
    const arrows = document.querySelectorAll('.testimonial-slider-arrow');
    if (arrows.length >= 2) {
      arrows[0].addEventListener('click', window.prevTestimonial);
      arrows[1].addEventListener('click', window.nextTestimonial);
    }
  }
  ...
  function init() {
    ...
    // Only generate transformations if the container exists
    const transformationsTrack = document.querySelector('.transformations-top-track');
    if (transformationsTrack) {
      console.log('Transformations track found, generating cards...');
...
`,
            basicInfo: {
                ...
                description: 'Transform your coaching business to 5 Lakhs/Month profit using AI agents. Zero tech method with complete time freedom.'
            },
            redirectPage: {
                url: '',
                openInNewTab: false
 ...
 'second_template': {
            name: 'FITNESS WEBINAR DAY 1 customar page',
        ...
        * {
        ...
        .stories-top-track {
            display: flex;
            gap: 30px;
            animation: slideRightSeamless 40s linear infinite;
            padding: 0 40px;
            width: fit-content;
        }
        ...
        .transformations-top-track {
            display: flex;
            gap: 35px;
            animation: slideRightSeamlessContinuous 40s linear infinite;
            padding: 0 40px;
            width: fit-content;
        }
        ...
        .transformations-bottom-track {
            display: flex;
            gap: 35px;
            animation: slideLeftSeamlessContinuous 40s linear infinite;
            padding: 0 40px;
            width: fit-content;
        }

        
        @keyframes slideRightSeamlessContinuous {
            from {
                transform: translateX(0%);
            }
            to {
        ...
        @keyframes slideLeftSeamlessContinuous {
            from {
                transform: translateX(-50%);
            }
            to {
        ...
        /* Transformation Row 2 - Unique Left to Right Animation */
        @keyframes transformationRow2LeftToRight {
            0% {
                transform: translateX(-50%);
            }
            100% {
        ...
        /* Testimonial Row 1 (Stories Top) - Unique Left to Right Animation */
        @keyframes testimonialRow1LeftToRight {
            0% {
                transform: translateX(-50%);
            }
            100% {
        ...
        .stories-bottom-track {
            display: flex;
            gap: 30px;
            animation: slideLeftSeamless 40s linear infinite;
            padding: 0 40px;
            width: fit-content;
        }
        .story-card {
        ...
        .stories-top-track {
            display: flex;
            gap: 30px;
            animation: slideRightSeamless 35s linear infinite;
        ...
        #custom-track-2 {
            display: flex;
            gap: 30px;
            animation: testimonialRow1LeftToRight 35s linear infinite;
            will-change: transform;
            padding: 0 40px;
            width: max-content;
        }
...
.transformations-top-row-unique {
    ...
    border: none;
        ...
        .transformations-top-track-unique {
            display: flex;
            gap: 35px;
            animation: slideRightToLeftUnique 40s linear infinite;
            padding: 0 40px;
            width: fit-content;
        }
        ...
        .transformations-bottom-track-unique {
            display: flex;
            gap: 35px;
            animation: slideLeftToRightUnique 40s linear infinite;
            padding: 0 40px;
            width: fit-content;
        }
  ...
  <div class="stories-bottom-row">
                ...
                <section class="faq-section section-padding">
                    <div class="container">
                        ...
                        <div class="faq-container">
                            <div class="faq-item">
                                <div class="faq-question"><span>Is this webinar really free?</span><span class="faq-arrow"></span></div>
                                <div class="faq-answer" id="answer-0" style="display: none;"><p>Yes, 100% free. No hidden costs, no credit card required. Just register with your name, email, and phone — that's it.</p></div>
                            </div>
                            <div class="faq-item">
                                <div class="faq-question"><span>How long is the webinar?</span><span class="faq-arrow"></span></div>
                                <div class="faq-answer" id="answer-1" style="display: none;"><p>90 minutes of pure value. We'll cover the complete 3-step system, answer your questions live, and reveal the exact roadmap you need to transform in 90 days.</p></div>
                            </div>
                            <div class="faq-item">
                                <div class="faq-question"><span>What if I can't attend live?</span><span class="faq-arrow"></span></div>
                                <div class="faq-answer" id="answer-2" style="display: none;"><p>We highly recommend attending live for the Q&A session and exclusive bonuses. However, no recordings available.</p></div>
                            </div>
                            <div class="faq-item">
                                <div class="faq-question"><span>Who is this for?</span><span class="faq-arrow"></span></div>
                                <div class="faq-answer" id="answer-3" style="display: none;"><p>Busy professionals — job holders, Entrepreneurs, Parents, Busy moms — who want to transform their health without sacrificing their career, family, or social life. If you're tired of diets that don't stick, this is for you.</p></div>
                            </div>
                            <div class="faq-item">
                                <div class="faq-question"><span>Do I need any equipment or gym membership?</span><span class="faq-arrow"></span></div>
                                <div class="faq-answer" id="answer-4" style="display: none;"><p>No. The system works anywhere — home, office, hotel room, park. No gym, no equipment, no special setup required.</p></div>
                            </div>
                             <div class="faq-item">
                                <div class="faq-question"><span>What if I've tried everything and failed before?</span><span class="faq-arrow"></span></div>
                                <div class="faq-answer" id="answer-5" style="display: none;"><p>That's exactly why this system exists. It's designed for people who've tried diets, programs, and challenges — and failed. The problem wasn't you. It was the system. We fix that.</p></div>
                            </div>
                             <div class="faq-item">
                                <div class="faq-question"><span>Will this work for my specific health condition?</span><span class="faq-arrow"></span></div>
                                <div class="faq-answer" id="answer-6" style="display: none;"><p>This system has helped people with diabetes, thyroid issues, PCOS, high cholesterol, and more. However, always consult your doctor before starting any health program.</p></div>
                            </div>
                             <div class="faq-item">
                                <div class="faq-question"><span>How is this different from other programs?</span><span class="faq-arrow"></span></div>
                                <div class="faq-answer" id="answer-7" style="display: none;"><p>Most programs give you a meal plan and workout routine — then leave you alone. We teach you a SYSTEM that adapts to your life, travels with you, and lasts forever. It's not a diet. It's a lifestyle operating system.</p></div>
                            </div>
                        </div>
                    </div>
                </section>
              ...
              <footer class="footer">
        <div class="container">
          <div class="footer-content" style="text-align: center; margin-bottom: 20px;">
            <div style="margin-bottom: 10px;">
              <h3 class="footer-title text-glow" style="margin: 0; font-weight: bold;">[COACH NAME]</h3>
            </div>
            <div style="margin-bottom: 10px;">
              <a href="mailto:coach@email.com" class="footer-email">📧 10x Shape Coach</a>
            </div>
            <div style="margin-bottom: 10px;">
              <a href="#" class="footer-link" style="margin-right: 15px;">Privacy Policy</a>
              <a href="#" class="footer-link" style="margin-right: 15px;">Terms of Service</a>
              <a href="#" class="footer-link">Disclaimer</a>
            </div>
            <div>
              <p style="margin: 0; font-size: 12px; color: #666;">© 2025 All Rights Reserved</p>
            </div>
          </div>
          
          <div class="disclaimers" style="font-size: 11px; line-height: 1.4;">
            <div class="disclaimer-section">
              <div class="disclaimer-title" style="font-size: 13px; font-weight: bold;">Medical Disclaimer:</div>
            ...
            <div class="disclaimer-section">
              <div class="disclaimer-title" style="font-size: 13px; font-weight: bold;">Results Disclaimer:</div>
            ...
            <div class="disclaimer-section">
              <div class="disclaimer-title" style="font-size: 13px; font-weight: bold;">Professional Disclaimer:</div>
            ...
            <div class="disclaimer-section">
              <div class="disclaimer-title" style="font-size: 13px; font-weight: bold;">Earnings Disclaimer:</div>
            ...
            <div class="disclaimer-section">
              <div class="disclaimer-title" style="font-size: 13px; font-weight: bold;">Liability Disclaimer:</div>
            ...
            `,
            js: `
// Transformation Row 1 - Right to Left (Top Row)
function setupTransformationRow1() {
    const track = document.getElementById("transformation-track-1-unique");
    if (track && !track.dataset.initialized) {
        const content = track.innerHTML;
        // Triple the content for smooth seamless loop - shows all cards before repeating
        track.innerHTML = content + content + content;
        track.dataset.initialized = "true";
        track.style.display = "flex";
        track.style.gap = "35px";
        track.style.animation = "slideRightToLeftUnique 120s linear infinite";
        track.style.padding = "0 40px";
        track.style.width = "fit-content";
        console.log("Transformation Row 1 initialized with slideRightSeamless animation");
    }
}

// Transformation Row 2 - Left to Right (Bottom Row) - UNIQUE ANIMATION
function setupTransformationRow2() {
    const track = document.getElementById("transformation-track-2-unique");
    if (track && !track.dataset.initialized) {
        const content = track.innerHTML;
        // Triple the content for smooth seamless loop - shows all cards before repeating
        track.innerHTML = content + content + content;
        track.dataset.initialized = "true";
        // Using separate animation specifically for Transformation Row 2
        track.style.display = "flex";
        track.style.gap = "35px";
        track.style.animation = "slideLeftToRightUnique 120s linear infinite";
        track.style.willChange = "transform";
        track.style.padding = "0 40px";
        track.style.width = "max-content";
        console.log("Transformation Row 2 initialized with transformationRow2LeftToRight animation");
    }
}

// Testimonial Row 1 (Custom Row 2) - Left to Right - UNIQUE ANIMATION
function setupTestimonialRow1() {
    const track = document.getElementById('custom-track-2');
    if (track && !track.dataset.initialized) {
        const content = track.innerHTML;
        ...
        track.style.animation = "testimonialRow1LeftToRight 40s linear infinite";
        track.style.padding = "0 40px";
        track.style.width = "fit-content";
        console.log("Testimonial Row 1 (custom-track-2) initialized with testimonialRow1LeftToRight animation");
    }
}

// Stories Bottom Row - Left to Right
function setupStoriesBottomRow() {
    const track = document.querySelector('.stories-bottom-track');
    if (track && !track.dataset.initialized) {
        const content = track.innerHTML;
        track.innerHTML = content + content;
        track.dataset.initialized = "true";
        track.style.display = "flex";
        track.style.gap = "30px";
        track.style.animation = "slideLeftSeamless 40s linear infinite";
        track.style.padding = "0 40px";
        track.style.width = "fit-content";
        console.log("Stories Bottom Row initialized with slideLeftSeamless animation");
    }
}

// Custom Row 3 - Right to Left  
function setupCustomRow3() {
    const track = document.getElementById('custom-track-3');
    if (track && !track.dataset.initialized) {
        const content = track.innerHTML;
        track.innerHTML = content + content;
        track.dataset.initialized = "true";
        track.style.display = "flex";
        track.style.gap = "30px";
        track.style.animation = "slideRightToLeft 40s linear infinite";
        track.style.padding = "0 40px";
        track.style.width = "fit-content";
        console.log("Custom Row 3 initialized with slideRightToLeft animation");
    }
}
...
function handlePlayButtonClick() {
    const placeholder = document.querySelector('.video-placeholder');
    if (placeholder) {
        placeholder.innerHTML = '<video class="active-video-player" controls autoplay style="width:100%; height:100%; object-fit:cover;" src="https://www.w3schools.com/html/mov_bbb.mp4"></video>';
    }
}
...
function toggleFAQ(index) {
    ...
    if (openFAQs[index]) {
        ...
        Object.keys(openFAQs).forEach(key => {
            if (openFAQs[key]) {
                const otherAnswer = document.getElementById('answer-' + key);
                const otherArrow = document.querySelectorAll('.faq-arrow')[key];
                if (otherAnswer) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.faq-arrow').forEach(arrow => {
        arrow.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>';
    });
    ...
    document.querySelectorAll('.enroll-button, .special-button, .floating-enroll-button').forEach(button => {
        button.addEventListener('click', function() {
    ...
    setTimeout(() => {
        setupTransformationRow1();      // Transformation Row 1: Right to Left
        setupTransformationRow2();      // Transformation Row 2: Left to Right (transformationRow2LeftToRight)
        setupTestimonialRow1();         // Testimonial Row 1 (custom-track-2): Left to Right (testimonialRow1LeftToRight)
        setupCustomRow3();              // Custom Row 3: Right to Left
    }, 100);
});`
        },
            ...
            "three_template": {
                "name": "FITNESS LEAD MAGNET - PAGE 1: OPT-IN LANDING customar page",
            ...
            <div class="fn3-page-container">
                ...
                <footer class="fn3-footer">
                    <div class="fn3-footer-content">
                        <div class="fn3-footer-links" style="text-align: center; margin-bottom: 20px;">
                            <div style="display: inline-block; margin-right: 30px;">
                                <p style="margin: 0; font-weight: bold;">10X Shape Coach | Coach name</p>
                            </div>
                            <div style="display: inline-block; margin-right: 30px;">
                                <a href="#" style="margin-right: 10px;">Privacy Policy</a>
                                <a href="#" style="margin-right: 10px;">Terms of Service</a>
                                <a href="#">Disclaimer</a>
                            </div>
                        ...
                        <div class="fn3-footer-disclaimers" style="font-size: 11px; line-height: 1.4;">
                            <h4 style="font-size: 13px; margin-bottom: 10px;">Important Disclaimers:</h4>
    ...
    'five_template': {
            name: '3 funnal landing page customar page',
            description: 'A friendly welcome page with a clean design and clear CTA',
            thumbnail: 'https://placehold.co/400x300/16a34a/ffffff?text=+Blank&font=inter&size=50&style=flate',
                 css: `
        :root {
        ...
        animateOnScrollElements.forEach(el => {
            ...
            basicInfo: {
                title: 'Fitness Webinar Registration',
                description: 'Join our exclusive 3-day fitness transformation webinar for busy professionals. Learn the proven system to transform your health.'
            },
            redirectPage: {
                url: '',
                openInNewTab: false
           ...
           "three_template couch_page": {
            "name": "FITNESS LEAD MAGNET - PAGE 1: OPT-IN LANDING coach page",
            "description": "A friendly welcome page with a clean design and clear CTA, adapted for an energy recovery guide.",
            "thumbnail": "https://placehold.co/400x300/f97316/ffffff?text=Energy+Guide&font=roboto&style=flat",
            "css": `        
            :root {
...
'five_template couch_page': {
        name: '3 funnal landing page couch page',
        description: 'A friendly welcome page with a clean design and clear CTA',
        thumbnail: 'https://placehold.co/400x300/16a34a/ffffff?text=+Blank&font=inter&size=50&style=flate',
             css: `
    :root {
...
// Organize templates into Customer and Coach categories
export const organizedTemplates = {
    customer: {
        welcomeTemplates: {
            'warm_welcome': welcomeTemplates.welcomeTemplates['warm_welcome'],
            'second_template': welcomeTemplates.welcomeTemplates['second_template'],
            'three_template': welcomeTemplates.welcomeTemplates['three_template'],
            'four_template': welcomeTemplates.welcomeTemplates['four_template'],
            'five_template': welcomeTemplates.welcomeTemplates['five_template'],
        }
    },
    coach: {
        welcomeTemplates: {
            'three_template couch_page': welcomeTemplates.welcomeTemplates['three_template couch_page'],
            'four_template couch_page': welcomeTemplates.welcomeTemplates['four_template couch_page'],
            'five_template couch_page': welcomeTemplates.welcomeTemplates['five_template couch_page'],
        }
    }
};